...
# --- Extraction financière directe GLM Vision -----------------------------
...
DIRECT_FINANCIAL_NUM_CTX = int(os.getenv("DIRECT_FINANCIAL_NUM_CTX", "16384"))
...
DIRECT_FINANCIAL_RENDER_DPI = int(os.getenv("DIRECT_FINANCIAL_RENDER_DPI", "220"))
DIRECT_FINANCIAL_MAX_PAGES = int(os.getenv("DIRECT_FINANCIAL_MAX_PAGES", "60"))
DIRECT_FINANCIAL_PAGE_DELAY_SECONDS = float(
    os.getenv("DIRECT_FINANCIAL_PAGE_DELAY_SECONDS", "0.2")
)
DIRECT_FINANCIAL_MAX_IMAGE_DIMENSION = int(
    os.getenv("DIRECT_FINANCIAL_MAX_IMAGE_DIMENSION", "2200")
)
